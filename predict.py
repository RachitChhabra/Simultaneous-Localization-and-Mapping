...
noise = np.random.normal(0,0.1,(encoder_clicks.shape[0],no_of_particles))   #(116046, particles)
...
noise_yaw = np.random.normal(0,0.001,(yaw_n.shape[0],no_of_particles))   #(116046, particles)
yaw_n+=noise_yaw
